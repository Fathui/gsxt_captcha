    ...
    for ret in rets:
        ...
        if ret[1] > 0.5:
            ...
            try:
                ...
                path = 'python/hanzi_img/{}.jpg'.format(timestamp())
...
if __name__=='__main__':
    # 加载模型
    net, meta = load_dtc_module(b"cfg/yolo-origin.cfg", b"jiyan/backup/yolo-origin.backup" , b"cfg/yolo-origin.data")

    seg_all_img('jiyan/data/all_images.txt', net, meta)
